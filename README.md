...
## Install the App
The APK for the application can be downloaded from here: [MobiSpectral APK](https://drive.google.com/file/d/1PSTsraP-jw0oriX6LtzFAko8wwoh_ODT/view?usp=sharing "MobiSpectral Android Application"), [MobiSpectral APK (Universal)](https://drive.google.com/file/d/1PTKukhxSUIIPlZ5BdgdiZDa5hXmC8Yrm/view?usp=sharing "MobiSpectral (Universal) Android Application"). There are Information buttons ⓘ on each page (Fragment), which tells the user what to do.
...
- [Apples (90.2 MB)](https://drive.google.com/file/d/1P64_D6q9VCt20LQQiBf1dFlstu8xNuNK/view?usp=drive_link "Apples Test Dataset")
- [Kiwis (39.1 MB)](https://drive.google.com/file/d/1P4QsOfZwNz6Fb_k5y4OZiSdctMrWMSVt/view?usp=drive_link "Kiwis Test Dataset")
